...
//  NotificationService
//
//  Created by exs-mobile on 2018. 4. 19..
//  Copyright © 2018년 exs. All rights reserved.
//
...
class NotificationService: UNNotificationServiceExtension {
    ...
    override func didReceive(_ request: UNNotificationRequest, withContentHandler contentHandler: @escaping (UNNotificationContent) -> Void) {
        ...
        if let bestAttemptContent = bestAttemptContent {
            ...
            if let userInfo = request.content.userInfo as NSDictionary as? [String: Any], let imageURL = userInfo["img_url"] as? String {
                urlString = "http://memeplus.cafe24.com\(imageURL)"
            }
